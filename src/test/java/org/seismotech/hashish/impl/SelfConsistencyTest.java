...
import org.seismotech.hashish.test.Contester;

class SelfConsistencyTest {

  static Stream<Hashing> hashings() {
    return Stream.of(
      org.seismotech.hashish.impl.adler.AdlerHashing8.THE,
      org.seismotech.hashish.impl.adler.AdlerHashing8X.THE,
      org.seismotech.hashish.impl.adler.AdlerHashing8Vector.THE,
      new org.seismotech.hashish.impl.sip.SipHashing._2_4(0,0),
      new org.seismotech.hashish.impl.xx.XX32Hashing(0),
      new org.seismotech.hashish.impl.xx.XX64Hashing(0),
      new org.seismotech.hashish.impl.murmur3.Murmur32Hashing(0),
      new org.seismotech.hashish.impl.murmur3.Murmur128x32Hashing(0),
      new org.seismotech.hashish.impl.murmur3.Murmur128x64Hashing(0)
    );
  }
